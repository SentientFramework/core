...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [SentientFramework](https://github.com/SentientFramework) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for SentientFramework.
...
```bash
git clone https://github.com/SentientFramework/core
cd core
go mod download
```
